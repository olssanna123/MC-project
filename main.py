...
from region import region_approximation_graphic

# coordinates for approximation region as tuples
# North east south west coordinates (latitude, longitude)
Ale_tuples = [(58.116472, 12.397922), (57.990763, 12.410281), (57.805393, 12.016147), (58.002408, 12.130130)]

# North east south west coordinates [latitude, longitude]
Ale_lists = [[58.116472, 12.397922], [57.990763, 12.410281], [57.805393, 12.016147], [58.002408, 12.130130]]
...
p = random_pos_within_region.random_point_within_region(Ale_tuples)
print(p)

region_approximation_graphic.plot_approximation(Ale_lists, p)
